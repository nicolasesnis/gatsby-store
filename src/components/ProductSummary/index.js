...
sizes = {
  this.props.mainImage.childImageSharp.sizes
}
alt = {
  this.props.name
}
/> </Item.Image>)
} > < Modal.Content image > < Image wrapped centered size = "big" > < Img
...
<Item.Content>
      ...
      <p > {
        this.props.meta.display_price.with_tax.formatted
      } </p> <Image.Group size = "tiny" >
      <Modal trigger = { < Button style = {
          {
            padding: '0'
          }
        } > < Image rounded alt = "mainImage"
        style = {
          {
            margin: "0"
          }
        ...
        /></Image > </Button>}> <Modal.Content image >
        <Image wrapped size centered  = "big" >
        <Img
